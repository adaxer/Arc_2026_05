...
public static class Services
{
    ...
    /// <summary>
    /// The name of the Desktop client service.
    /// This service is responsible for hosting the desktop application.
    /// </summary>
    ...
    /// </summary>
    public const string Database = "SparkasseDb";
}
