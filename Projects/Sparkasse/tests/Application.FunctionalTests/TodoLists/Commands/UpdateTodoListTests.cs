using Sparkasse.Application.Common.Exceptions;
using Sparkasse.Application.TodoLists.Commands.CreateTodoList;
using Sparkasse.Application.TodoLists.Commands.UpdateTodoList;
using Sparkasse.Domain.Entities;

namespace Sparkasse.Application.FunctionalTests.TodoLists.Commands;
